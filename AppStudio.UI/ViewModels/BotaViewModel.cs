...
{
    public class BotaViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "BotaDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new BotaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("BotaDetail");
        }
