...
{
    public class KurioziteteViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "KurioziteteDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new KurioziteteDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("KurioziteteDetail");
        }
    }
}
